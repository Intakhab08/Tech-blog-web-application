...
<html>
    <head>
        ...
        <style>
            ...
            body{
                background: url(img/blogpot.jpg);
    ...
    <body>
        <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v19.0" nonce="dV80kj9z"></script>
        <!-- navbar -->
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="contact.jsp"><span class="fa fa-address-book-o"></span>About Us</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav mr-right">
                    <li class="nav-item">
                        <a class="nav-link" href="#!" data-toggle="modal" data-target="#profile-modal"><span class="fa fa-user-circle"></span></span><%= user.getName()%></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row my-4">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer primary-background d-flex justify-content-between">
                            <% 
                            ...
                            <div>
                                <button id="delete-post-button" type="button" class="btn btn-danger btn-sm">DELETE</button>
                                <button id="edit-post-button" type="button" class="btn btn-outline-light btn-sm">EDIT POST</button>
                            </div>
                        </div>
